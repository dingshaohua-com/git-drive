...
<div class="min-h-screen flex items-center justify-center bg-white">
	<div class="bg-white rounded-xl md:shadow-[0_4px_8px_-4px_rgba(0,0,0,.13),0_6px_16px_0_rgba(0,0,0,.08),0_12px_24px_16px_rgba(0,0,0,.04)] p-10 w-full max-w-sm text-sm">
		...
		<div class="pt-1 h-6">
			{#if quickLoginType === 'password'}
				<div class="text-red-300 text-xs text-center">
				...
				{#if quickLoginType === 'email'}
					...
					<div class="flex">
						...
						<button
							...
							onclick={sendCode}
							disabled={isCodeSent}
							class="bg-blue-500 text-white rounded-r-lg hover:bg-blue-600 disabled:bg-gray-400  px-2"
		...
		<div class="mt-5">
			...
			<div class="flex justify-center gap-4 flex-wrap">
				<button
					...
					class="w-10 h-10 rounded-full flex items-center justify-center cursor-pointer transition-all {quickLoginType ===
					'password'
